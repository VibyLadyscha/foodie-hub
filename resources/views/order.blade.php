...
<html>
  ...
  <a href="{{ url('dashboard') }}"><img src="{{ asset('img/Panahkiri.svg') }}" style=" position:relative; width: 2%; top: -5px"></a>   Detail Order        
</div>
        ...
        <div class="col-md-12">
          <div class="card" style="margin-top: 40px;
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <img src="{{ url('img') }}/{{ $product->product_image }}" class="rounded mx-autod-block" width="100%" alt="food" />
                </div>
                <div class="col-md-6">
                  <h2 class="product-title" style="font-size: 48px; font-family: League Spartan; font-weight: 600; word-wrap: break-word; margin-top: 30px;">{{ $product->product_name }}</h2>
