...
<section class="fifty">
  <div class="main-container">
    ...
    <div class="text" style="left: 145px; top: 184px"></div>
  </div>
</section>
<section>
        ...
        <form action="{{ url('checkout') }}/{{ $temporary_order->id }}" method="POST">
          ...
          <tr>
            <div class="btn-group" style="position:relative; top: 90px; left: 150px">
              ...
              <td>
                <select name="payment_id" class="btn-group" style="width: 175px; height: 50px; font-size: 30px; font-family: League Spartan; font-weight: 200; word-wrap: break-word;">
