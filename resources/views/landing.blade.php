...
<body>
    <section class="hero">
        <nav class="navbar">
            ...
            <div class="images">
                <img src="img/balado.png" alt="Image 1" class="rotated1">
                <img src="img/ayamgor.png" alt="Image 2" class="rotated2">
                <img src="img/kepiting.png" alt="Image 3" class="rotated">
            </div>
...
<section class="heroho">
            ...
            <div class="hal2">
                <img src="img/daun.png" class="daun">
                <img src="img/tektek.png" class="tektek">
                <img src="img/esjeruk.png" class="esjeruk">
            </div>   
</section>
<section class="herohoho">
        ...
        <div class="imag"></div>
        <img class="food-image" src="img/Rectangle 22.png" alt="Food Image" style="left: 235px; top: 283px;">
        <img class="food-image" src="img/Rectangle 25.png" alt="Food Image" style="left: 736px; top: 437px;">
        <img class="food-image" src="img/tektek 1.png" alt="Food Image" style="left: 1237px; top: 281px;">
        <div class="food-name" style="left: 286px; top: 639px;">Ayam Serundeng</div>
</section>
<section class="opening-hours">
    ...
    <div class="opening-hours-text">Opening Hours</div>
